...
const Navber = () => {
  ...
  return (
    <div className="container mx-auto bg-[] ">
      <div className="navbar fixed z-10 rounded-lg text-white container mx-auto ">
        <div className="navbar-start">
          ...
          <div>
            <a className="btn uppercase btn-ghost text-xl   text-white">CAREERNESTLE</a>
          </div>
        </div>
        ...
        <div className="navbar-end">
          <div>
            <label onClick={handelThem} className="swap swap-rotate">
